package square.size.editor.puzz;

import java.util.ArrayList;
import java.util.List;

import square.size.editor.puzz.straight.layout.NormalLayout;
import square.size.editor.puzz.straight.layout.OneStraightLayout;
import square.size.editor.puzz.straight.layout.TwoStraightLayout;
