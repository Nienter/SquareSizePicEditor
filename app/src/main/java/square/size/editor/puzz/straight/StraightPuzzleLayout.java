package square.size.editor.puzz.straight;
...
import square.size.editor.puzz.view.Area;
import square.size.editor.puzz.view.Line;
import square.size.editor.puzz.view.PuzzleLayout;

import static square.size.editor.puzz.straight.StraightUtils.createLine;
import static square.size.editor.puzz.straight.StraightUtils.cutAreaCross;
import static square.size.editor.puzz.straight.StraightUtils.cutAreaSpiral;
...
public abstract class StraightPuzzleLayout implements PuzzleLayout {
  ...
  protected void cutAreaEqualPart(int position, int part, Line.Direction direction) {
    ...
    PuzzleLayout.Step step = new Step();
